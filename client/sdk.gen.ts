...
import type { GetTodosData, GetTodosResponse, CreateTodoData, CreateTodoResponse, DeleteTodoData, DeleteTodoResponse, GetTodoByIdData, GetTodoByIdResponse, UpdateTodoData, UpdateTodoResponse } from './types.gen';
...
export const deleteTodo = <ThrowOnError extends boolean = false>(options: Options<DeleteTodoData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteTodoResponse, unknown, ThrowOnError>({
        url: '/todos/{todoId}',
        ...options
    });
};
